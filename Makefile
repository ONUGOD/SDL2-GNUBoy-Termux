...
SYS_INCS = -I/data/data/com.termux/files/usr/include  -I./sys/nix

SDL_OBJS = sys/sdl2/sdl-video.o sys/sdl2/sdl-audio.o sys/sdl2/sdl-input.o
SDL_LIBS = -L/data/data/com.termux/files/usr/lib -lSDL2 -lpthread
SDL_CFLAGS = -I/data/data/com.termux/files/usr/include/SDL2 -D_GNU_SOURCE=1 -D_REENTRANT `sdl2-config --cflags --libs`
...
clean:
	rm -f *gnuboy sdl2gnuboy.exe gmon.out *.o sys/*.o lib/*/*.o sys/*/*.o src/*.o $(OBJS)
